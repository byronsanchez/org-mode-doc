...
** Filtering
   ...
   How do we do this?  Get a list of all tasks with =F12 t= and then
...
*** Automatically removing context based tasks with / RET
    =/ RET= in the agenda is special.  It removes tasks automatically by
    ...
    I work from home and set up my day as follows:
      ...
      - Tasks requiring internet access need to be able to ping norang.ca (@inet)
      - Home tasks are done outside working hours (@home)

    I have the following setup to allow =/ RET= to filter based on what the computer can figure out as relative
    context for the time I run the / RET 
...
:   ** TODO 30 minute brisk walk
:      SCHEDULED: <2009-11-04 Wed .+1d/2d>                                         
:      :PROPERTIES:
:      :STYLE:    habit
:      :END:
