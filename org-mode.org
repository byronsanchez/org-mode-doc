...
digraph G {
  ...
  subgraph cluster_wrapline {
    ...
    color=purple;
    sharedmem; exec; opserver; db; plc;
    sharedmem [style=filled, fillcolor=green, shape=box, label="Shared Memory"];
    sharedmem -> exec;
    sharedmem -> db;
    sharedmem -> plc;
    sharedmem -> opserver;
  ...
  plcnet [style=filled,fillcolor=red, shape=box, label="PLC Network"];
  plc [style=filled, fillcolor=purple, label="Wrapline PLC Interface"];
  exec [style=filled, fillcolor=purple, label="Wrapline Executive"];
  db [style=filled, fillcolor=purple, label="Wrapline Database"];
  opserver [style=filled, fillcolor=purple, label="Wrapline Operator Server"];
  plcnet -> plc;
  db -> millwide;
  opserver -> client1;
  opserver -> client2;
