...
every major context I clock time in.  If I am working on norang.ca
tasks, then I set the norang.org =* Organization= task as the default
task.  If I'm working for client ABC then I set the =* Organization=
task in ABC.org as the default task etc.  This allows me to block time
...
today's date is May 23 and you enter a date for May 21st (2 days ago)
org-mode will jump to May 21st next year.  I find this annoying when I
want to look at what happened last Wednesday since I have to specify
the year.
