...
#+begin_src emacs-lisp :tangle yes
  ...
  (defun bh/clock-in-to-started (kw)
    "Switch task from TODO, NEXT, or WAITING to STARTED when clocking in.
  Skips capture tasks."
    (if (and (member (org-get-todo-state) (list "TODO" "NEXT" "WAITING"))
...
I found this annoying when I used =plantuml= as on my abbreviations.
