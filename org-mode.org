...
#+end_src
** Playing with graphviz					   :noexport:
[[http://www.graphviz.org/][Graphviz]] is another great tool for creating graphics in your documents.

*NOTE* graphviz support is not currently part of the official org-mode
       repository.  This uses a modifed =org-exp-blocks.el= posted to
       the mailing list on May 27, 2009.
