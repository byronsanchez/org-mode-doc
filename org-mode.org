...
: ** TODO Step 3
   ...
   In this case you need to complete =Step 1= before you can do
   complete =Step 2=, etc. and org-mode prevent the state change to a
   done task until the preceeding tasks are complete.
