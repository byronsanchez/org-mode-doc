...
#+begin_src emacs-lisp
  ...
  (setq org-remember-templates (quote (("todo" ?t "* TODO %?\n  %u\n  %a" nil bottom nil)
                                       ("note" ?n "* %?                                        :NOTE:\n  :CLOCK:\n  :END:\n  %U\n  %a" nil bottom nil)
                                       ("Phone" 80 "* TODO Phone [[bbdb:%(gjg/bbdb-name)][%(gjg/bbdb-name)]] - %(gjg/bbdb-company)               :PHONE:\n  %U\n  %?" nil bottom nil)
    ...
    (defun bh/phone-call ()
      ...
      (let* ((myname (completing-read "Who is calling? " (bbdb-hashtable) 'bbdb-completion-predicate 'confirm))
        ...
        (setq gjg/remember-phone-record
              (or (when my-bbdb-name
                    (first (bbdb-search (bbdb-records) my-bbdb-name nil nil)))
                  myname))
        (other-window 1)
        (let ((org-remember-templates '(("Phone" 80 "* TODO Phone [[bbdb:%(gjg/bbdb-name)][%(gjg/bbdb-name)]] - %(gjg/bbdb-company)               :PHONE:\n  %U\n  %?" nil bottom nil))))
          (org-remember nil "P"))))
