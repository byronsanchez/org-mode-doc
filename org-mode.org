...
#+end_example
    ...
    This makes it possible to refine the project tasks into subtasks as 
    you work on the project without losing the original estimate data.
    
*** Reviewing your estimate
    =Column view= is great for reviewing your estimate.  This shows
    your estimate value and the total clock time for the project.
    ...
    =C-c C-x C-d= provides a quick summary of clocked time for the
    current org file.
* Archiving
** Archiving Subtrees
