...
** UNFINISHED Org file structure
   Most of my org files are set up with level 1 headings as main categories only.
   Tasks and projects normally start as level 2 or higher.

   These are some of my level 1 headings in =todo.org=:
   - Appointments
   - Special Dates
   - Finances
   - Health
   ...
   Sometimes projects are level 1 tasks.

   Each of these level 1 tasks normally has a =property drawer=
   specifying the archive location for any tasks in that tree.  An
   example level 1 heading is setup like this:
#+begin_example 
** Miscellaneous
   :PROPERTIES:
     :CATEGORY: todo
...
#+end_example
   ...
   level 1 =Miscellaneous= headline so I can find it back again if
   needed.  This keeps my main org files and my archives with
