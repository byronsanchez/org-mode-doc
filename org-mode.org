...
** UNFINISHED Playing with graphviz
*** Small Graph
...
digraph G {
  ...
  node [shape=box,style=filled,color=".78 .3 1.0"];
  execute -> compare;
};
#+end_dot
***  Polygonal Shapes
#+begin_dot dot gv03.png -Tpng
digraph G {
  a -> b -> c;
  b -> d;
