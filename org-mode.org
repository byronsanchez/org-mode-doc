...
lets you defined TODO keywords per file.  I find it's easier to have a
...
Normal tasks go through the sequence
...
#+begin_ditaa task_states3.png -r -S
:       +--------+       +---------+       +--------+
:       |        |       |         |       |        |
:       |  TODO  +------>+ STARTED +------>+  DONE  |
:       | cRED   |       |  cBLU   |       | cGRE   |
...
#+begin_ditaa task_states4.png -r -S
:       +--------+       +---------+       +--------+
:       |        |       |         |       |        |
:       |  TODO  +------>+ STARTED +------>+  DONE  |
:       | cRED   |       |  cBLU   |       | cGRE   |
...
I also do fixed-price quotation work and use the sequence

*QUOTATION* -> *QUOTED* -> *APPROVED* | *EXPIRED* | *REJECTED* 

for this.  Fixed price jobs normally have a /Purchase Order/ associated with it
so the *OPENPO* and *CLOSEDPO* states are used to track active and complete purchase orders.

Finally I also track projects which are really super-tasks.  Projects normally have lots of individual tasks
that can be estimated and clocked.  I use

*PROJECT* -> *PROJDONE* | *PROJCANCELLED*

to track the project parent task.
