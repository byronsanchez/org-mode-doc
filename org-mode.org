...
#+end_src
** Agenda Setup
   I have lots of org files.  I deal with multiple clients and client
   projects and separate these into one org file per client normally.
   Clients come and go so I can add or drop entire org files from my
...
* Refiling Tasks
  ...
  notes.org) for up to a week.  Often I end up refiling tasks the
  same day I create them .  If I have multiple tasks that should be
  refiled to the same org file and task I reorder the tasks in the
